...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 691.0, 47.0, 139.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 691.0, 79.745289027690887, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 621.0, 478.566062867641449, 32.0, 22.0 ],
					"text" : "gate"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 150.000004649162292, 139.43040943145752, 19.0, 20.0 ],
									"text" : "b"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 92.452832162380219, 139.43040943145752, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 150.000004649162292, 104.524747431278229, 19.0, 20.0 ],
									"text" : "m"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 92.452832162380219, 104.524747431278229, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 50.0, 139.43040943145752, 29.5, 22.0 ],
									"text" : "+ 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 50.0, 104.524747431278229, 29.5, 22.0 ],
									"text" : "* 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.000026943183911, 40.000000375000013, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 141.452846943183886, 40.000000375000013, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 96.452846943183886, 40.000000375000013, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.000026943183911, 225.011718374999987, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 678.735873999999967, 277.566053569316864, 51.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 748.0, 552.471726030111313, 104.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 123.0, 392.0, 41.0, 22.0 ],
					"text" : "buddy"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 236.339631676673889, 334.226433515548706, 68.0, 22.0 ],
					"text" : "zl group 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 621.0, 585.0, 61.0, 22.0 ],
					"text" : "unpack f f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 621.0, 508.566062867641449, 24.0, 24.0 ]
				}

			}
, 			{
				"box" : 				{
					"fontsize" : 12.816566464000859,
					"id" : "obj-2",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 1,
...
,
					"text" : "js linearregression.js"
				}

			}
, 			{
				"box" : 				{
					"fontsize" : 18.253164054964468,
					"format" : 6,
					"id" : "obj-83",
					"maxclass" : "flonum",
					"numinlets" : 1,
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 423.69813746213913, 626.377389192581177, 87.0, 29.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 472.800007045269012, 329.600004911422729, 66.400000989437103, 29.0 ],
					"textcolor" : [ 1.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"fontsize" : 17.859850052052273,
					"id" : "obj-81",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 483.235874056816101, 626.377389192581177, 91.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 460.800006866455078, 360.00000536441803, 91.0, 26.0 ],
					"text" : "Total Error",
					"textcolor" : [ 1.0, 0.0, 0.0, 1.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 215.509456813335419, 267.54717481136322, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 215.509456813335419, 300.943403244018555, 417.0, 22.0 ],
									"text" : "definerange 0 10, defineline none, definepoint square, definecolor 1. 0. 0. 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 113.207547783851624, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 149.896228432655334, 391.0, 22.0 ],
									"text" : "definerange 0 10, defineline none, definepoint dot, definecolor 0. 0. 1. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 128.188699245452881, 185.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 128.188699245452881, 218.396228432655334, 403.0, 22.0 ],
									"text" : "definerange 0 10, defineline linear, definepoint none, definecolor 0. 1. 0. 1."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 49.999999783134463, 345.943373997669255, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 128.188720783134499, 345.943373997669255, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 215.5094607831345, 345.943373997669255, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 217.864611017172933, 435.169834434986115, 79.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 423.69813746213913, 589.886822760105133, 43.0, 22.0 ],
					"text" : "zl sum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 452.000025570392609, 493.660403192043304, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.69813746213913, 552.471726030111313, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 151.339631676673889, 334.226433515548706, 68.0, 22.0 ],
					"text" : "zl group 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 340.679265677928925, 371.018888056278229, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 602.000032544136047, 327.622659623622894, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					"fontsize" : 26.083021362869765,
					"id" : "obj-49",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 439.735874056816101, 223.849069893360138, 212.452813565731049, 36.0 ],
					"text" : "y = mx + b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 439.735874056816101, 327.622659623622894, 151.0, 22.0 ],
					"text" : "sprintf set y = %.1fx + %.1f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 377.471720218658447, 435.169834434986115, 68.0, 22.0 ],
					"text" : "zl group 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 377.471720218658447, 185.169822812080383, 155.0, 20.0 ],
					"text" : "Our line (to match the data)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 377.471720218658447, 391.77360600233078, 29.5, 22.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 377.471720218658447, 356.867944002151489, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 377.471720218658447, 278.566053569316864, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 377.471720218658447, 313.471715569496155, 51.0, 22.0 ],
					"text" : "uzi 10 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 29.358496487140656, 199.84905594587326, 63.433960378170013, 33.0 ],
					"text" : "Concerts attended"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 151.339631676673889, 67.245289027690887, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 151.339631676673889, 102.150951027870178, 51.0, 22.0 ],
					"text" : "uzi 10 0"
				}
...
, 			{
				"box" : 				{
					...
					"range" : 10,
					"size" : 10,
					"table_data" : [ 0, 9, 8, 7, 6, 5, 4, 3, 2, 1, 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-101" : [ "live.text[3]", "live.text", 0 ],
